...
where first_name in ("vidya", "Maya", "Irene")
order by first_name; -- 10256,10360, 13237
...
first_name = "Maya" or 
first_name = "Irene"
order by first_name, last_name; -- Irene aingworth and vidya zweizig
...
first_name = "Maya" or 
first_name = "Irene"
order by last_name, first_name;-- irene aingworth, maya zyda 
...
order by emp_no; -- 10021 ramzi erde and 499684 tadahiro erde
...
order by hire_date; -- 10050 yinghue dredge and 468081 steve strehl
